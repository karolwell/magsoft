...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`magsoft` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
insert  into `categorie`(`id`,`libelle`,`description`,`date`) values 
(1,'Cooperative','Information sur les coopératives','2019-04-08 09:04:30');
...
(2,'Administrateur','{\"1\":\"\",\"2\":\"1,2,3\",\"14\":\"5,7\",\"15\":\"6,8\",\"16\":\"9,11\",\"\":0}','0000-00-00','Droit général sur l\' application ',1,1),
...
(5,'Direction','{\"1\":\"\",\"2\":\"1,2,3\",\"16\":\"9,11\",\"\":0}','0000-00-00','Profile directement lié à la direction droit à tous les menus',1,1);
...
(1,'well','90414158','iwell@well.fr','?JI?قo???\Z???qb???͗?Z?Z??~','$2y$13$7sByo/QBZdxzRPiHRKtw4uIN2ujBj6AwSiTwwqto.mwQbhzotxuRS',NULL,2,10,10,1498678008,1498678008),
