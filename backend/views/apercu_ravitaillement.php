        ...
        <div class="modal-content ">
            <div class="modal-body height-">
                ...
                <div class="row vertical-align text-justify">
                    <?php $form = ActiveForm::begin(['id' => 'form-Stock', 'method'=>'Post','action'=>Yii::$app->homeUrl.'entreestock/ajout_stock','options'=>['entype'=>'multipart/form-data']]); ?>
                    <div id="new-datas" class="col-md-12">

                    </div>
                    <div class="form-group col-md-12">
                        <label>Joindre la fiche justificative du ravitaillement</label>
