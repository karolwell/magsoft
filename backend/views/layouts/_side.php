...
<div class="side-panel-wrapper bg-white">
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item active">
            <a class="nav-link" href="index.html#chat" role="tab" data-toggle="tab">
                <span>Chat</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="index.html#profile" role="tab" data-toggle="tab">
                <span>Profile</span>
            </a>
        </li>
        <li class="nav-item ">
            <a class="nav-link" href="index.html#todo-list" role="tab" data-toggle="tab">
                <span>Todo</span>
            </a>
        </li>
